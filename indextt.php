...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form class="" action="" method="post" autocomplete="off">
      ...
      <input type="text" class="input" placeholder="Jouney ID" name="journey" id = "journey" required value=""> <br>
    ...
    <div class="input-field">
      ...
      <input type="text" class="input" placeholder="Cargo Company Name" name="cargo" id = "cargo" required value=""> <br>
      <i class='bx bx-user-circle' ></i>
    </div>
