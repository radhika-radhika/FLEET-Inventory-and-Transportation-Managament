...
?>
      ...
      <input type="text" class="input" placeholder="Shipment ID" name="journey" id = "journey" required value="<?php echo $arrdata['journey']; ?>"> <br>
    ...
    <div class="input-field">
      ...
      <input type="text" class="input" placeholder="Destination" name="dest" id = "dest" required value="<?php echo $arrdata['dest']; ?>"> <br>
      <i class='bx bx-location-plus'></i>
    </div>

    <div class="input-field">
      <label for="cargo"></label>
      <input type="text" class="input" placeholder="Transport Company Name" name="cargo" id = "cargo" required value="<?php echo $arrdata['cargo']; ?>"> <br>
      <i class='bx bx-user-circle' ></i>
    </div>
